...
/**
 * @ngdoc service
 * @name nethvoiceWizardUiApp.ProvisioningUiService
 * @description
 * # ProvisioningUiService
 * Service in the nethvoiceWizardUiApp.
 */
angular.module('nethvoiceWizardUiApp')
  .service('ProvUiService', function ($q, RestService) {

    this.uiUtils = function (filtered) {
      var utils = {
        language_map : {
          "Bosnian" : "Bosanski",
          "Danish" : "Dansk",
        ...
        tonezone_map: {
          ...
          "United States Circa 1950/ North America" : "us-old",
